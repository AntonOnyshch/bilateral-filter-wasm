(module
    ...
    (type $kernel_signature (func (param $central_pixel i32)(param $start_position i32)(result i32)))
    ...
    (func $run
        ...
        (if (i32.eq (i32.const 3 (global.get $kernel_size)))
            (then 
                (loop $height_loop
                    (local.set $j (global.get $half_kernel_size))
                    (local.set $height_index (i32.add (global.get $input_image_offset (i32.mul (global.get $width (local.get $i))))))
                    ...
                    (loop $width_loop
                        ...
                        (local.set $startPosition (i32.add (local.get $startHeight (i32.sub (global.get $half_kernel_size (local.get $j))))))
                        (local.set $pixel (call $kernel3x3 (i32.load8_u (local.get $central_pixel_index)) (local.get $startPosition)))
        ...
        (if (i32.eq (i32.const 5 (global.get $kernel_size)))
            (then 
                (loop $height_loop
                    (local.set $j (global.get $half_kernel_size))
                    (local.set $height_index (i32.add (global.get $input_image_offset (i32.mul (global.get $width (local.get $i))))))
                    ...
                    (loop $width_loop
                        (local.set $central_pixel_index (i32.add (local.get $j (local.get $height_index))))
                        (local.set $startPosition (i32.add (local.get $startHeight (i32.sub (global.get $half_kernel_size (local.get $j))))))
                        (local.set $pixel (call $kernel5x5 (i32.load8_u (local.get $central_pixel_index)) (local.get $startPosition)))
                        (i32.store8 (i32.add (global.get $image_size (local.get $central_pixel_index))) (local.get $pixel))
                        (local.set $j (i32.add (i32.const 1 (local.get $j))))
                        (i32.lt_u (local.get $j) (local.get $end_width))
                        br_if $width_loop
        ...
        (if (i32.eq (i32.const 7 (global.get $kernel_size)))
            (then 
                (loop $height_loop
                    (local.set $j (global.get $half_kernel_size))
                    (local.set $height_index (i32.add (global.get $input_image_offset (i32.mul (global.get $width (local.get $i))))))
                    ...
                    (loop $width_loop
                        (local.set $central_pixel_index (i32.add (local.get $j (local.get $height_index))))
                        (local.set $startPosition (i32.add (local.get $startHeight (i32.sub (global.get $half_kernel_size (local.get $j))))))
                        (local.set $pixel (call $kernel7x7 (i32.load8_u (local.get $central_pixel_index)) (local.get $startPosition)))
                        (i32.store8 (i32.add (global.get $image_size (local.get $central_pixel_index))) (local.get $pixel))
                        (local.set $j (i32.add (i32.const 1 (local.get $j))))
                        (i32.lt_u (local.get $j) (local.get $end_width))
                        br_if $width_loop
        ...
        (if (i32.eq (i32.const 9 (global.get $kernel_size)))
            (then 
                (loop $height_loop
                    (local.set $j (global.get $half_kernel_size))
                    (local.set $height_index (i32.add (global.get $input_image_offset (i32.mul (global.get $width (local.get $i))))))
                    ...
                    (loop $width_loop
                        (local.set $central_pixel_index (i32.add (local.get $j (local.get $height_index))))
                        (local.set $startPosition (i32.add (local.get $startHeight (i32.sub (global.get $half_kernel_size (local.get $j))))))
                        (local.set $pixel (call $kernel9x9 (i32.load8_u (local.get $central_pixel_index)) (local.get $startPosition)))
                        (i32.store8 (i32.add (global.get $image_size (local.get $central_pixel_index))) (local.get $pixel))
                        (local.set $j (i32.add (i32.const 1 (local.get $j))))
                        (i32.lt_u (local.get $j) (local.get $end_width))
                        br_if $width_loop
        ...
        (if (i32.eq (i32.const 11 (global.get $kernel_size)))
            (then 
                (loop $height_loop
                    (local.set $j (global.get $half_kernel_size))
                    (local.set $height_index (i32.add (global.get $input_image_offset (i32.mul (global.get $width (local.get $i))))))
                    ...
                    (loop $width_loop
                        (local.set $central_pixel_index (i32.add (local.get $j (local.get $height_index))))
                        (local.set $startPosition (i32.add (local.get $startHeight (i32.sub (global.get $half_kernel_size (local.get $j))))))
                        (local.set $pixel (call $kernel11x11 (i32.load8_u (local.get $central_pixel_index)) (local.get $startPosition)))
                        (i32.store8 (i32.add (global.get $image_size (local.get $central_pixel_index))) (local.get $pixel))
                        (local.set $j (i32.add (i32.const 1 (local.get $j))))
                        (i32.lt_u (local.get $j) (local.get $end_width))
                        br_if $width_loop
        ...
        (if (i32.eq (i32.const 13 (global.get $kernel_size)))
            (then 
                (loop $height_loop
                    (local.set $j (global.get $half_kernel_size))
                    (local.set $height_index (i32.add (global.get $input_image_offset (i32.mul (global.get $width (local.get $i))))))
                    ...
                    (loop $width_loop
                        (local.set $central_pixel_index (i32.add (local.get $j (local.get $height_index))))
                        (local.set $startPosition (i32.add (local.get $startHeight (i32.sub (global.get $half_kernel_size (local.get $j))))))
                        (local.set $pixel (call $kernel13x13 (i32.load8_u (local.get $central_pixel_index)) (local.get $startPosition)))
                        (i32.store8 (i32.add (global.get $image_size (local.get $central_pixel_index))) (local.get $pixel))
                        (local.set $j (i32.add (i32.const 1 (local.get $j))))
                        (i32.lt_u (local.get $j) (local.get $end_width))
                        br_if $width_loop
    ...
    (func $kernel3x3 (param $central_pixel i32)(param $start_position i32)(result i32)
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (local.get $start_position))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
        (local.tee $weight (f32.mul (f32.load (local.get $counter))))
        (f32.convert_i32_u (local.get $nearby_pixel))
        f32.mul
        (local.set $sum_weight (f32.add (local.get $sum_weight)))
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 1 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 2 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
        ...
        local.get $normalize_weight
        f32.div
        i32.trunc_f32_u
    )

    (func $kernel5x5 (param $central_pixel i32)(param $start_position i32)(result i32)
        (local $sum_weight f32)
        (local $normalize_weight f32)
        (local $weight f32)
        (local $counter i32)
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 3 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 4 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
    ...
    (func $kernel7x7 (param $central_pixel i32)(param $start_position i32)(result i32)
        (local $sum_weight f32)
        (local $normalize_weight f32)
        (local $weight f32)
        (local $counter i32)
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 5 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 6 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
    ...
    (func $kernel9x9 (param $central_pixel i32)(param $start_position i32)(result i32)
        (local $sum_weight f32)
        (local $normalize_weight f32)
        (local $weight f32)
        (local $counter i32)
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 7 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 8 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
    ...
    (func $kernel11x11 (param $central_pixel i32)(param $start_position i32)(result i32)
        (local $sum_weight f32)
        (local $normalize_weight f32)
        (local $weight f32)
        (local $counter i32)
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 9 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 10 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
    ...
    (func $kernel13x13 (param $central_pixel i32)(param $start_position i32)(result i32)
        (local $sum_weight f32)
        (local $normalize_weight f32)
        (local $weight f32)
        (local $counter i32)
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 11 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
        ...
        (i32.sub (local.get $central_pixel) (local.tee $nearby_pixel (i32.load8_u (i32.add (i32.const 12 (local.get $start_position))))))
        (i32.trunc_f32_u (f32.abs (f32.convert_i32_s)))
        (i32.mul (i32.const 4))
        f32.load
        local.tee $intensity_lut_value
